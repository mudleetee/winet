...
$sql="SELECT * FROM wi_fixed WHERE fixed_type = '470 MHz (6 หลัก)' and fixed_active = 'y' ORDER BY fixed_id ASC, customer_name DESC "; //ORDER BY promotion_price DESC, promotion_name DESC";

...
foreach($arr as $a)	{
	//echo $a . "</br>";								//debug
	//$sql="SELECT * FROM wi_service2 WHERE location_id = '$a' " ;
	$sql="SELECT * FROM wi_service2 WHERE location_id = '$a' and service_active = 'y'" ;  //เอา locationที่มี  เลขหมาย Active ทีละ location
...
$lo[1]	= "3471LC001 (วัดราษฎร์ธรรมมาราม)";
$lo[2]	= "3471LC002 (คลองโคน)";
...
$lo[9]	= "3475LC000 (วัดเพชรรัตน์)";
$lo[10]	= "3475LC001 (คลองขุดเล็ก)";
$lo[11]	= "3475LC002 (ดอนมะโนรา)";
$lo[12]	= "3475LC003 (บ้านคลองบางนางลี่)";
$lo[13]	= "3475LC004 (วัดต้นลำแพน)";
$lo[14]	= "3475LC005 (วัดสี่แยกราษฎร์บำรุง)";
$lo[15]	= "3475LC006 (บ้านรั้ว ม.3 แพรกหนามแดง)";
